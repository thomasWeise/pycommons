"""Test running the documentation maker from the command line."""
...
def test_make_documentation_from_command_line() -> None:
    """Test running the documentation maker."""
    ...
    Command([PYTHON_INTERPRETER, "-m",
             "pycommons.dev.building.make_documentation",
