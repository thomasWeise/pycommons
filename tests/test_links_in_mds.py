...
def test_links_in_security_md() -> None:
    """Test the links in the SECURITY.md file."""
    check_links_in_md(file_path(__file__).up(
        2).resolve_inside("SECURITY.md"))


def test_links_in_license() -> None:
    """Test the links in the LICENSE file."""
    check_links_in_md(file_path(__file__).up(
        2).resolve_inside("LICENSE"))
